...
export class ErrorWithContext extends Error {
  ...
  constructor(message?: string, context?: Record<string, unknown>, hints?: string[]) {
    super(message);
 ...
 * @param hints 
 */
export const error = (message?: string, context?: Record<string, unknown>, hints?: string[]): never => {
